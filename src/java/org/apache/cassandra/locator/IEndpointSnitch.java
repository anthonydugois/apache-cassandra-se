...
public interface IEndpointSnitch
{
    ...
    public <C extends ReplicaCollection<? extends C>> C sortedByProximity(final InetAddressAndPort address, C addresses, ReadOperation<SinglePartitionReadCommand> operation);
