...
public class ByteArraySerializer implements FactSerializer<String>
{
    ...
    @Override
    public void serialize(String bytes, DataOutputPlus out, int version) throws IOException
    {
    ...
    @Override
    public long serializedSize(String bytes, int version)
    {
        return size;
    }
}
